...
const ServiceCard = ({ icon: Icon, title, description, features, className = "" }: ServiceCardProps) => {
  ...
  return (
    <motion.div
      ...
      className={`relative group glass-panel shimmer p-6 md:p-8 overflow-hidden transition-all hover:border-primary/50 shadow-premium hover:shadow-xl dark:shadow-none dark:hover:shadow-none ${className}`}
    >
